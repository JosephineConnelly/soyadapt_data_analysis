...
#   plot-vcfstats founders_missing_stats.vchk -p founders_missing_stats/
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='<STDI')
    has_data = 1
